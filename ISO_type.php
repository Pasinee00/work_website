...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="7" background="images/bgtab_green.jpg">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="5" cellpadding="0"  bgcolor="#FFFFFF">
	  ...
	  ?>
      <tr>
        <td class="topic_green"><?=$row_menu[menu_name]?></td>
      </tr>
       <?
			$sql="SELECT
						tb_page.page_id,
      ...
      <? $sql_page="SELECT
			...
			?>
      <tr>
        <td class="topic_green">File Download</td>
      </tr>
      <tr>
        <td class="text_black_normal"><table width="672" border="0" cellpadding="0" cellspacing="0">
        <tr>
        <td width="29" bgcolor="#66CC00">ลำดับ</td>
      	<td width="346" align="center" bgcolor="#66CC00">รายการ</td>
        <td bgcolor="#66CC00">ชื่อไฟล์</td>
        <td width="71" align="center" bgcolor="#66CC00">วันที่อัพไฟล์</td>
        <td width="98" align="center" bgcolor="#66CC00">ดาวน์โหลด</td>
        </tr>
	  <?
	  ...
	  ?>
  		<tr>
            ...
            <td width="97" valign="middle"><?=$row_page[link_name]?>&nbsp;</td>
            <td width="72" align="center"><?=sS($row_page[link_date])?>&nbsp;</td>
            <td align="left" valign="middle"><a href="download.php?link_localtion=<?=$row_page[link_localtion]?>">&gt;&gt;Download&lt;&lt;</a></td>
         </tr> 
      <?
			}
			}//if
