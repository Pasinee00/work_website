...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="7" background="images/bgtab_yellow.jpg">
  <tr>
    ...
    <td width="680" valign="top" class="margin_white"><table width="100%" border="0" cellspacing="5" cellpadding="0">
      <tr>
        <td class="topic_yellow">ความปลอดภัย</td>
      </tr>
      <tr>
        <td align="center"><img src="sample/sample3.jpg" width="670" height="300"></td>
      </tr>
      <tr>
      <td class="topic_yellow">ข่าวสาร</td>
      </tr>
     <tr>
      	<td>
      <? 
      ...
      <?
		    if($num>=6){
	  ?>
           <td align="right"><a href="safety_allnews.php?cate_id=3" >ดูทั้งหมด..</a></td>
        <?		
			}
	   ?>
       </tr>
