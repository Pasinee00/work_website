...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="7" background="images/bgtab_green.jpg">
  <tr>
    ...
    <td width="680" align="left" valign="top" class="margin_white">
    <table width="100%" border="0" cellspacing="5" cellpadding="0">
      <tr>
        <td class="topic_green">ISO 14001</td>
      </tr>
      <tr>
        <td align="center"><img src="sample/sample1.jpg" width="670" height="300"></td>
      </tr>
      <tr>
        <td class="topic_green">ข่าวสาร</td>
      </tr>
      <tr>
      	<td>
      <? 
	  	$sql="SELECT
					...
					echo "<table border=\"1\" cellspacing=\"1\" cellpadding=\"1\" bordercolor=\"#009900\" width=\"100%\" <tr  width=\"25%\"> ";
					$i=0;
	  ...
	  ?>
       ...
       <?
		...
		echo "<td width=\"500px\">";
	   ?>
       <a href="news_detilISO.php?news_id=<?=$row[news_id]?>&cate_id=<?=$row[cate_id] ?>" >  <?=$row[news_title] ?></a>
       <?
	   		if($row[news_check]==1){
		?>
      ...
      <?
		    if($num>=6){
	  ?>
           <td align="right"><a href="ISO_allnews.php?cate_id=1" >ดูทั้งหมด..</a></td>
        <?		
			}
	   ?>
       </tr>
