                            ...
                            <div class="page-wrapper">
                                <!-- Page-header start -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="inputPassword" class="col-sm-2 col-form-label"><span class="text-danger">*</span>วันที่ต้องอนุมัติ </label>
                                        <div class="col-sm-4">
                                        <input type="date" class="form-control" id="approve_date" name="approve_date" placeholder="">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="file" id="files_pdf2" name="files_pdf2" accept="application/pdf application/vnd.ms-excel" class="form-control" required>
