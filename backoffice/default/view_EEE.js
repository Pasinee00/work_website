...
const edit_EEE = (id) => {
    location.href = "update_EEE.php?section=2&DID="+id;
    // alert(id);
}
                ...
                if(items.send_to_approve!='Y' ){
                        if(items.Doc_use == 'Y'){
                            table += `<tr>
                                            ...
                                            <td><center><button class="btn btn-warning btn-outline-warning" onclick="edit_EEE(${items.id})"><i class="icofont icofont-ui-edit"></i>แก้ไข</button></center></td>
                                            <td><center>
...
const add_approve = () => {
    location.href = "update_EEE.php?section=2";
}
