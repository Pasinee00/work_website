                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-1"><button class="btn btn-success" onclick="add_master_doc()"><i class="icofont icofont-plus-circle"></i>เพิ่มเอกสาร</button></div>
                                                    </div>
                                                    <div class="row">
                                                    </div>
                                                    <div class="row">
...
<!-- Custom js -->
<script type="text/javascript" src="show_EEE.js"></script>
